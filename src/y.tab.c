...
{
       0,   256,   257,   258,    40,    42,    41,    43,    45,    47
};
# endif
...
{
       4,    -5,    10,     1,    -5,     4,     4,     4,     4,    -4,
      -5,     4,     4,     4,     4,    -5,    14,    15,    16,    17,
      -5,    -5,    -5,    -5
};
...
{
       9,    10,    15,    11,    12,    13,    14,     1,     2,    16,
      17,    18,    19,     1,     2,     5,     0,     6,     7,     8,
      20,    21,    22,    23
};

static const yytype_int8 yycheck[] =
{
       2,     0,     6,     5,     6,     7,     8,     3,     4,    11,
      12,    13,    14,     3,     4,     5,    -1,     7,     8,     9,
       6,     6,     6,     6
};
...
{
       0,     3,     4,    11,    12,     5,     7,     8,     9,    12,
       0,    12,    12,    12,    12,     6,    12,    12,    12,    12,
       6,     6,     6,     6
};
...
#line 29 "parser.y" /* yacc.c:1646  */
    {(yyval.node) = make_ast_node_function(SUBTR, (yyvsp[-2].node), (yyvsp[-1].node));}
#line 1243 "y.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 30 "parser.y" /* yacc.c:1646  */
    {(yyval.node) = make_ast_node_function(DIV, (yyvsp[-2].node), (yyvsp[-1].node));}
